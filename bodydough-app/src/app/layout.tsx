...
import { Inter ,Prompt, Sriracha } from 'next/font/google'
import './globals.css'
...
export default function RootLayout({
  ...
  return (
    <html lang="en" >
      <body className={`${prompt.variable} ${inter.variable} ${sriracha.variable} w-screen h-screen flex items-center justify-center`}>
