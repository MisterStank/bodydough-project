                ...
                <div className="m-5 flex w-[90%] sm:w-[70%] max-h-[400px] sm:max-h-[600px] relative flex-col item-center">
                    <div className='p-5 w-[100%] max-h-[400px] sm:max-h-[600px] text-[min(4vw,1.5rem)] text-gray-700 rounded-lg 
                        ...
                        <div className="m-5 leading-relaxed
                            ...
                            โดยมีเกณฑ์ดังนี้<br/>
                            น้อยกว่า 18.50 kg/m<sup>2</sup> อยู่ในเกณฑ์ผอม<br/>
                            ระหว่าง 18.50-22.90 kg/m<sup>2</sup> อยู่ในเกณฑ์ปกติ<br/>
                            ระหว่าง 23.00-24.90 kg/m<sup>2</sup> อยู่ในเกณฑ์อ้วนระดับ 1<br/>
                            ระหว่าง 25.00-29.90 kg/m<sup>2</sup> อยู่ในเกณฑ์อ้วนระดับ 2<br/>
                            มากกว่า 30.00 kg/m<sup>2</sup> อยู่ในเกณฑ์อ้วนระดับ 3<br/>
                            หมายเหตุ<br/>
